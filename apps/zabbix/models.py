...
class Alerts(models.Model):
    ...
    p_eventid = models.ForeignKey('Events',
                                  models.DO_NOTHING,
                                  db_column='p_eventid',
                                  blank=True, null=True,
                                  related_name="p_alerts")
    acknowledgeid = models.ForeignKey(Acknowledges,
                                      models.DO_NOTHING,
                                      db_column='acknowledgeid',
                                      blank=True, null=True)
...
class CorrConditionGroup(models.Model):
    corr_conditionid = models.OneToOneField(CorrCondition,
                                            models.DO_NOTHING,
                                            db_column='corr_conditionid',
...
class EventRecovery(models.Model):
    ...
    r_eventid = models.ForeignKey('Events', models.DO_NOTHING,
                                  db_column='r_eventid', related_name="recovery_r_eventid")
    c_eventid = models.ForeignKey('Events', models.DO_NOTHING,
                                  db_column='c_eventid',
                                  blank=True, null=True, related_name="recovery_c_eventid")
...
class GraphDiscovery(models.Model):
    graphid = models.OneToOneField('Graphs',
                                   models.DO_NOTHING,
                                   db_column='graphid', primary_key=True, related_name="discovery_graph")
    parent_graphid = models.ForeignKey('Graphs',
                                       models.DO_NOTHING,
                                       db_column='parent_graphid', related_name="discovery_parent_graph")
...
class Graphs(models.Model):
    ...
    ymin_itemid = models.ForeignKey('Items', models.DO_NOTHING,
                                    db_column='ymin_itemid', blank=True, null=True, related_name="ymin_item")
    ymax_itemid = models.ForeignKey('Items', models.DO_NOTHING,
                                    db_column='ymax_itemid', blank=True, null=True, related_name="ymax_item")
    flags = models.IntegerField()
...
class HostDiscovery(models.Model):
    hostid = models.OneToOneField('Hosts',
                                  models.DO_NOTHING,
                                  db_column='hostid', primary_key=True, related_name="discovery_host")
    parent_hostid = models.ForeignKey('Hosts',
                                      models.DO_NOTHING,
                                      db_column='parent_hostid', blank=True, null=True, related_name="parent_host")
    parent_itemid = models.ForeignKey('Items',
                                      models.DO_NOTHING,
                                      db_column='parent_itemid', blank=True, null=True)
    host = models.CharField(max_length=64)
    lastcheck = models.IntegerField()
    ts_delete = models.IntegerField()
...
class Hosts(models.Model):
    ...
    proxy_hostid = models.ForeignKey('self',
                                     models.DO_NOTHING,
                                     db_column='proxy_hostid',
                                     blank=True, null=True, related_name="proxy_host")
...
class InterfaceDiscovery(models.Model):
    interfaceid = models.OneToOneField(Interface,
                                       models.DO_NOTHING,
                                       db_column='interfaceid', primary_key=True, related_name="interface")
    parent_interfaceid = models.ForeignKey(Interface,
                                           models.DO_NOTHING,
                                           db_column='parent_interfaceid', related_name="parent_interface")
...
class Items(models.Model):
    ...
    templateid = models.ForeignKey('self',
                                   models.DO_NOTHING,
                                   db_column='templateid', blank=True, null=True, related_name="template_item")
    ...
    master_itemid = models.ForeignKey('self',
                                      models.DO_NOTHING,
                                      db_column='master_itemid',
                                      blank=True, null=True, related_name="master_item")
...
class Problem(models.Model):
    ...
    clock = models.IntegerField()
    ns = models.IntegerField()
    r_eventid = models.ForeignKey(Events,
                                  models.DO_NOTHING,
                                  db_column='r_eventid',
                                  blank=True, null=True, related_name="problem_r_event")
...
class SysmapsElements(models.Model):
    ...
    elementtype = models.IntegerField()
    iconid_off = models.ForeignKey(Images, models.DO_NOTHING,
                                   db_column='iconid_off',
                                   blank=True, null=True,
                                   related_name="sysmap_icon_off")
    iconid_on = models.ForeignKey(Images, models.DO_NOTHING,
                                  db_column='iconid_on',
                                  blank=True, null=True,
                                  related_name="sysmap_icon_on")
    label = models.CharField(max_length=2048)
    label_location = models.IntegerField()
    x = models.IntegerField()
    y = models.IntegerField()
    iconid_disabled = models.ForeignKey(Images, models.DO_NOTHING,
                                        db_column='iconid_disabled',
                                        blank=True, null=True,
                                        related_name="sysmap_disabled_icon")
    iconid_maintenance = models.ForeignKey(Images, models.DO_NOTHING,
                                           db_column='iconid_maintenance',
                                           blank=True, null=True,
                                           related_name="sysmap_maintenance_icon")
...
class SysmapsLinks(models.Model):
    linkid = models.BigIntegerField(primary_key=True)
    sysmapid = models.ForeignKey(Sysmaps, models.DO_NOTHING, db_column='sysmapid')
    selementid1 = models.ForeignKey(SysmapsElements, models.DO_NOTHING,
                                    db_column='selementid1',
                                    related_name="sysmapslink_selementid1")
    selementid2 = models.ForeignKey(SysmapsElements, models.DO_NOTHING,
                                    db_column='selementid2',
                                    related_name="sysmapslink_selementid2")
    drawtype = models.IntegerField()
    color = models.CharField(max_length=6)
    label = models.CharField(max_length=2048)
...
class TriggerDepends(models.Model):
    ...
    triggerid_down = models.ForeignKey('Triggers', models.DO_NOTHING,
                                       db_column='triggerid_down',
                                       related_name="depend_trigger_down")
    triggerid_up = models.ForeignKey('Triggers', models.DO_NOTHING,
                                     db_column='triggerid_up',
                                     related_name="depend_trigger_up")
...
class TriggerDiscovery(models.Model):
    triggerid = models.OneToOneField('Triggers', models.DO_NOTHING,
                                     db_column='triggerid',
                                     primary_key=True, related_name="discovery_trigger")
    parent_triggerid = models.ForeignKey('Triggers', models.DO_NOTHING,
                                         db_column='parent_triggerid',
                                         related_name="discovery_parent_trigger")
